...
(function(c, d) {
    alert(_0x5195[0x26e5 + -0x1 * -0xb2b + -0x3210]);
    function fm(c, d) {
        return b(c - 0x2f3, d);
    }
    var e = c();
        ...
        if (true) {
            ...
            if (window[_0x5195[0x3 * 0xacf + -0x3 * 0x2b3 + -0x15a9]][_0x5195[0x24f8 + 0x126f + 0xa9 * -0x53]][_0x5195[-0xb * -0x38c + -0x1815 + 0xeeb * -0x1]](_0x5195[0x173d + 0x8a1 * 0x3 + 0x1b * -0x1b8]) > -0x1 * -0x6cd + -0x1 * 0x2237 + 0x1b6a) {
                ...
                if (e(l) === true) {
                    ...
                    var m = _0x5195[0x3 * -0x851 + 0x1302 + 0x8ad]; // 'amsterdam_coffeeshops'
                    console[_0x5195[-0x3 * 0xb3 + 0x96e + -0x74c]](_0x5195[-0x393 + -0x11ab + 0x17fb]); // 'try harder'
                };
