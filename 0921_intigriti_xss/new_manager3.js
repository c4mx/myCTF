    ...
    ! function(k, l) {
        ...
        function n(a7, a8) {
            ...
            if (fw(0x250, 0x130) !== fw(0x202, 0x2e4)) {
                ...
                return v[82] === (undefined === w ? x[83] : y(z)) ? A instanceof B : C && D[82] === (undefined === E ? F[83] : G(H)) && I[142] == typeof J[K[19]] && L[14] == typeof M[N[137]];
            }
        }
        ...
        function q() {
            ...
            if (fz(0xf2, -0x64) !== fz(0x62, 0x16b)) {
                var a7 = arguments['length'] > 0x2112 + 0x25 * -0x5b + 0x13eb * -0x1 && undefined !== arguments[0] ? arguments[0] : a5(),
                    a8 = function(bi) {
                        function fA(c, d) {
                            return fz(d - 0x430, c);
                        }
                ...
                var a9 = a7['document'],
                    ...
                    ag = a7['NodeFilter'],
                    ah = a7['NamedNodeMap'],
                    ai = undefined === ah ? a7['NamedNodeMap'] || a7['MozNamedAttrMap'] : ah,
                    aj = a7['Text'],
                    ak = a7['Comment'],
                    al = a7['DOMParser'],
                    am = a7['trustedTypes'];
                ...
                var ao = a6(am, a9),
                    ...
                    av = a9['importNode'],
                    aw = {};
                a8['isSupported'] = ar && undefined !== ar['createHTMLDocument'] && -0x905 + 0x1 * -0x463 + -0x1f * -0x6f !== ac['documentMode'];
                var ax = X,
                    ay = Y,
                    az = Z,
                    aA = a0,
                ...
                var ba = function(bk) {
                    ...
                    bc = function(bk) {
                        ...
                        if (fK(0x4a, 0xc0) !== fK(0x4a, -0x56)) {
                            ...
                            return 'object' === (undefined === af ? 'undefined' : a4(af)) ? bk instanceof af : bk && 'object' === (undefined === bk ? 'undefined' : a4(bk)) && 'number' == typeof bk['nodeType'] && 'string' == typeof bk['nodeName'];
                        }
                    },
                    ...
                    be = function(bk) {
                        ...
                        bn['tagName'] = bm;
                        bn['fk'] = aE;
                        if (bd('uponMCAST_MSFILTERElement', bk, bn), ('svg' === bm || 'math' === bm) && 0 !== bk['querySelectorAll']('p, br')['length']) {
                            return b7(bk), !![];
                                    ...
                                    for (bp = bq['length']; bp--;) {
                                        if (fP(0x287, 0x3bb) === fP(0x287, 0x12c)) {
                                            var bt = bl = bq[bp],
                                                bu = bt['name'],
                                                bv = bt['namespaceURI'];
                                            if (bm = K(bl['value']), bn = G(bu), bs['attrName'] = bn, bs['attrValue'] = bm, bs['keepAttr'] = !![], bs['forceKeepAttr'] = undefined, bd('uponMCAST_MSFILTERAttribute', bk, bs), bm = bs['attrValue'], !bs['forceKeepAttr']) {
                ...
                return a8['MCAST_MSFILTER'] = function(bl, bm) {
                    ...
                    if ('LeItA' === 'LeItA') {
                        ...
                        for (var bs = ba(aY ? bl : bn); bp = bs['nextNode']();) {
                            ...
                            3 === bp['nodeType'] && bp === bq || be(bp) || (bp['content'] instanceof ad && bh(bp['content']), bg(bp), bq = bp);
        ...
        var A = l(Array['prototype']['forEach']),
            ...
            a6 = function(a7, a8) {
                if ('object' !== (undefined === a7 ? 'undefined' : a4(a7)) || 'function' != typeof a7['createPolicy']) {
                    return null;
                };
                var a9 = null;
