                ...
                return a8['MCAST_MSFILTER'] = function(bl, bm) {
                    ...
                    if (fR(-0x78, 0x93) === fR(-0x78, 0xf9)) {
                        ...
                        if (bl || (bl = '<!-->'), 'string' != typeof bl && !bc(bl)) {
                            if ('function' != typeof bl['toString']) {
                                if (fR(0x28, 0x4b) !== fR(0xdf, 0xc3)) {
                                    throw N('toString is not a function');
                                } else {
                                    var bw = {};
                                    bw[fR(0x25d, 0x2a5)] = i[692];
                                    bw[fR(0x29b, 0x355)] = j[693];
                                    bw[fR(0xe3, 0x159)] = k[694];
                                    bw[fR(0xbf, 0x91)] = l[695];
                                    h(bw);
                                }

                            if ('string' != typeof(bl = bl[fR(0x1eb, 0x1f1)]())) {
